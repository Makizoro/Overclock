...
public class loadSocietyUserFrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        @SuppressLint("InflateParams") ViewGroup root = (ViewGroup) inflater.inflate(R.layout.load_society_user_frag_layout,null);
        RecyclerView rv = root.findViewById(R.id.rcyViewLoadSocietyUser);
        setRecyclerView(rv);
        return root;
    }

    public void setRecyclerView(RecyclerView rv){
        Query query = csiRef.whereEqualTo("type","Society")
