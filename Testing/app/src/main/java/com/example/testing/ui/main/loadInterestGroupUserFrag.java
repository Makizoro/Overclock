...
public class loadInterestGroupUserFrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        @SuppressLint("InflateParams") ViewGroup root = (ViewGroup) inflater.inflate(R.layout.load_interest_group_user_frag_layout,null);
        RecyclerView rv = root.findViewById(R.id.rcyViewLoadInterestGroupUser);
        setRecyclerView(rv);
        return root;
    }

    public void setRecyclerView(RecyclerView rv){
        Query query = csiRef.whereEqualTo("type","Interest Group")
